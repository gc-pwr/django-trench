...
USER_ACTIVE_FIELD = "USER_ACTIVE_FIELD"

# JWT Cookie settings
JWT_REFRESH_COOKIE_NAME = "JWT_REFRESH_COOKIE_NAME"
JWT_REFRESH_COOKIE_SECURE = "JWT_REFRESH_COOKIE_SECURE"
JWT_REFRESH_COOKIE_HTTPONLY = "JWT_REFRESH_COOKIE_HTTPONLY"
JWT_REFRESH_COOKIE_SAMESITE = "JWT_REFRESH_COOKIE_SAMESITE"
JWT_REFRESH_COOKIE_PATH = "JWT_REFRESH_COOKIE_PATH"
JWT_REFRESH_COOKIE_DOMAIN = "JWT_REFRESH_COOKIE_DOMAIN"
...
JWT_ACCESS_COOKIE_SECURE = "JWT_ACCESS_COOKIE_SECURE"
JWT_ACCESS_COOKIE_HTTPONLY = "JWT_ACCESS_COOKIE_HTTPONLY"
JWT_ACCESS_COOKIE_SAMESITE = "JWT_ACCESS_COOKIE_SAMESITE"
JWT_ACCESS_COOKIE_PATH = "JWT_ACCESS_COOKIE_PATH"
JWT_ACCESS_COOKIE_DOMAIN = "JWT_ACCESS_COOKIE_DOMAIN"
...
DEFAULTS = {
    ...
    # JWT Cookie settings defaults
    "JWT_REFRESH_COOKIE_NAME": "refresh_token",
    "JWT_REFRESH_COOKIE_SECURE": True,
    "JWT_REFRESH_COOKIE_HTTPONLY": True,
    "JWT_REFRESH_COOKIE_SAMESITE": "Lax",  # Changed from Strict to Lax for cross-subdomain
    "JWT_REFRESH_COOKIE_PATH": "/",
    "JWT_REFRESH_COOKIE_DOMAIN": None,  # Set to .yourdomain.com in your settings
    "JWT_ROTATE_REFRESH_TOKENS": False,
    # Access token cookie settings defaults
    "JWT_ACCESS_COOKIE_NAME": "access_token",
    "JWT_ACCESS_COOKIE_SECURE": True,
    "JWT_ACCESS_COOKIE_HTTPONLY": True,
    "JWT_ACCESS_COOKIE_SAMESITE": "Lax",  # Same as refresh token for cross-subdomain
    "JWT_ACCESS_COOKIE_PATH": "/",
    "JWT_ACCESS_COOKIE_DOMAIN": None,  # Set to .yourdomain.com in your settings
    "MFA_METHODS": {
        "sms_twilio": {
